# EntityWithState.gd
# BaseEntity con State Machine integrada.
# Extiende esta clase para crear entidades con comportamiento por estados.
# EJEMPLO de uso:
#   class_name Player
#   extends EntityWithState
#   func _setup():
#       add_to_group("player")
#       _change_state(IdleEntityState.new())
...
# Llamar esto para cambiar de estado
# El owner_node se setea AQUI antes de enter()
